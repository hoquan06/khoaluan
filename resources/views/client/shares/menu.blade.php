                                    ...
                                    <ul class="mega-menu d-lg-flex">
                                        ...
                                        <li class="mega-menu-col col-lg-5">
                                            <div class="header-banner2">
                                                <img src="/assets_client/images/menu_banner7.jpg" alt="menu_banner1">
                                            ...
                                            <div class="header-banner2">
                                                <img src="/assets_client/images/menu_banner8.jpg" alt="menu_banner2">
                                                <div class="banne_info">
                                                    <h6>15% Off</h6>
                                                    <h4>Top Laptops</h4>
                                                    <a href="#">Shop now</a>
                                                ...
                                                <div class="header_banner_content">
                                                    <div class="shop_banner">
                                                        <div class="banner_img overlay_bg_40">
                                                            <img src="/assets_client/images/shop_banner4.jpg" alt="shop_banner2">
                                                        </div>
