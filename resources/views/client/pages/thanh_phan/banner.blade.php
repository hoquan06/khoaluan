            	...
            	<div class="banner_section shop_el_slider">
                    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active background_bg" data-img-src="/assets_client/images/banner13.jpg">
                            ...
                            <div class="carousel-item background_bg" data-img-src="/assets_client/images/banner14.jpg">
                                <div class="banner_slide_content banner_content_inner">
                            ...
                            <div class="carousel-item background_bg" data-img-src="/assets_client/images/banner15.jpg">
                                <div class="banner_slide_content banner_content_inner">
                                    <div class="col-lg-8 col-10">
                                        <div class="banner_content3 overflow-hidden">
            ...
            <div class="col-lg-2 d-none d-lg-block">
            	<div class="shop_banner2 el_banner1">
                	<a href="#" class="hover_effect1">
                        ...
                        <div class="el_img">
                			<img src="/assets_client/images/shop_banner_img6.png" alt="shop_banner_img6">
                        </div>
                    </a>
                </div>
                <div class="shop_banner2 el_banner2">
                	<a href="#" class="hover_effect1">
                        ...
                        <div class="el_img">
                			<img src="/assets_client/images/shop_banner_img7.png" alt="shop_banner_img7">
                        </div>
                    </a>
                </div>
            </div>
