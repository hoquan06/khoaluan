    ...
    <div class="col-xl-8 col-md-6 col-12">
        <div class="card card-statistics">
            <div class="card-header">
                <h4 class="card-title">Thống kê tháng này</h4>
            ...
            <div class="card-body statistics-body">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0 text-center hideShowKhachHang">
                        <div class="media">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12 text-center">
                        <div class="media">
                            ...
                            <div class="media-body my-auto">
                                @foreach ($doanhThuThangTruoc as $key=>$value)
                                    <h4 class="font-weight-bolder mb-0">{{number_format($value->doanh_thu)}} VND</h4>
                                @endforeach
                                <p class="card-text font-small-3 mb-0">Doanh thu tháng trước</p>
                            </div>
                        </div>
                    </div>
                </div>
...
{{-- <div class="table-responsive card" id="tableKhachHang">
    <div class="main-card mb-3 card">
        <div class="card-body"><h5 class="card-title">Danh Sách Khách Hàng Mua Trong Tháng</h5>
            <table class="mb-0 table table-bordered table-hover" id="tableSanPham">
                ...
                <tbody class="text-nowrap text-center">
                    @foreach($thongTinTheoThang as $key => $value)
                        <tr>
                            <td>{{ $key + 1 }}</td>
